...
export default function DistractionsButton() {
    ...
    return (
        <button className="distractions" color='EB6565'>
            <div>
            <svg width="35px" height="30px" viewBox="0 0 512.00 512.00" xmlns="http://www.w3.org/2000/svg" aria-hidden="true" role="img" preserveAspectRatio="xMidYMid meet" fill="#ffffff" stroke="#ffffff" stroke-width="0.00512">
                <g id="SVGRepo_bgCarrier" stroke-width="0" fill='#EB6565'></g>
                <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="23.552"></g>
